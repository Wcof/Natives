export const en = {
  ...
  settings: {
    ...
    visualBlur: 'Blur Amount',
    visualDisplacement: 'Displacement Scale',
    visualSaturation: 'Saturation',
    visualAberration: 'Chromatic Aberration',
    visualElasticity: 'Elasticity',
    visualCornerRadius: 'Corner Radius',
    visualMockupWallpaper: 'Mockup Wallpaper',
    visualBubbles: 'Bubbles',
    visualPreview: 'LiquidGlass Preview',
    visualTuningTitle: 'Liquid Glass Visual Tuning',
    widgetTitle: 'Natives Control Hub Widget',
    widgetDesc: 'Launch the desktop floating widget window, offering liquid glass visual controllers, system monitoring, and quick toggles.',
    widgetLaunch: 'Launch Control Hub Widget',
