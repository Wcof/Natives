export const en = {
  ...
  settings: {
    ...
    baseUrl: 'Base URL',
    providerSetupIntro: 'OpenAI-compatible APIs are currently supported. Choose a preset or use a custom provider.',
  ...
  usage: {
    ...
    emptyHint: 'Data sources include local Claude Code, Codex, and Atomcode logs, plus ccusage external sources. Make sure tools are in use.',
