    ...
    >
      <div className="relative w-full max-w-lg rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-2xl space-y-5">
        <div className="flex items-center justify-between">
          <h2 id="add-app-title" className="text-base font-semibold text-[var(--text)]">
        ...
        <div className="flex rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-hover)] p-1">
          <button
            type="button"
