    ...
    <div className="flex flex-col h-full">
      <div className="px-3 py-3">
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg bg-[var(--vibe-active-bg)] text-[var(--vibe-active-color)] text-sm font-medium hover:opacity-80 transition-opacity"
        >
      ...
      <div className="flex-1 overflow-y-auto px-2 space-y-0.5">
        {loading ? (
          <div className="px-3 py-8 text-center text-xs text-[var(--text-faint)]">{t('loading')}</div>
        ) : sessions.length === 0 ? (
          <div className="px-3 py-8 text-center text-xs text-[var(--text-faint)]">{t('noSessions')}</div>
        ) : (
          sessions.map((session) => (
            ...
            >
              ...
              <span className="text-[0.625rem] text-[var(--text-faint)] opacity-0 group-hover:opacity-100 transition-opacity">
