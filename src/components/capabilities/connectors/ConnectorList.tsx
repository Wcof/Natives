...
function statusBadge(locale: Locale, status: string | null) {
  ...
  const color = running ? 'var(--success, #10b981)' : failed ? 'var(--danger)' : 'var(--text-disabled)';
  return (
            ...
            <div className="flex items-center gap-2">
              ...
              <span
                ...
                style={{
                  ...
                  color: server.enabled ? 'var(--success, #10b981)' : 'var(--text-disabled)',
                }}
              >
                {server.enabled
              ...
              <span
                ...
                style={{
                  borderColor: 'var(--border-subtle)',
                  color: server.trusted ? 'var(--success, #10b981)' : 'var(--warning)',
                }}
              >
                {server.trusted
