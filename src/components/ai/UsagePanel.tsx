...
export default function UsagePanel() {
  ...
  return (
    <div style={{ padding: 'var(--space-sm)' }}>
      <div style={{ display: 'flex', gap: SPACING.xs, marginBottom: SPACING.sm, borderBottom: '1px solid var(--border)' }}>
        {tabs.map((t) => (
          <button
            key={t.id}
        ...
        <div>
          {usageData?.claude ? (
            <>
              ...
              {/* 活跃统计 */}
              <div style={{ display: 'flex', gap: SPACING.md, fontSize: FONT_SIZE.xs, color: 'var(--text-faint)', marginBottom: SPACING.md }}>
            ...
            <div style={{ fontSize: FONT_SIZE.sm, color: 'var(--text-faint)' }}>
          ...
          <button
            ...
            onClick={fetchUsage}
            disabled={loading}
            style={{ marginTop: 8, fontSize: FONT_SIZE.sm }}
          >
