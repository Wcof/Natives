    ...
    match request.method.as_str() {
        ...
        names::RUN_WATCH => {
            ...
            for event in cap_wire_replay(replayed) {
                ...
                if write_stream_frame(writer, &crate::stream_protocol::RunStreamFrameV2::durable_event(&run_id, &event))
                    .await
                    .is_err()
                {
            ...
            for ev in live_replay {
                ...
                if write_stream_frame(writer, &crate::stream_protocol::RunStreamFrameV2::live_event(&run_id, &ev))
                    .await
                    .is_err()
                {
                    return;
