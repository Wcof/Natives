...
/// Project instruction directories / discovery / digest / revision helpers
/// moved to `prepared_session_discovery` (W9); re-exported for compatibility.
pub use crate::prepared_session_discovery::{
    app_schema_revision, capability_audit_revision, capability_prompt_revision,
    discover_instruction_sources, discover_skill_entry_names, harness_revision,
    project_instruction_digest, project_instruction_dirs, project_instruction_metadata_fingerprint,
};
