...
use agent_core::{
    ...
    EngineToolRuntime, EventSequencer, PermissionManager, PermissionProfile, SubAgentConfig,
...
use provider_adapters::capabilities::{
    history_message_to_provider, HistoryMessage, HistoryToolCall, ProviderAdapter,
