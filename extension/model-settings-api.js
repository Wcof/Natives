...
const WRITE_METHODS = new Set([
  ...
  'model_usage_budget_upsert', 'model_usage_attention_ack',
  'model_usage_billing_entry_upsert',
...
export function createModelSettingsAPI({ onEvent, onDisconnect } = {}) {
  ...
  return {
    ...
    setDefaultModel: (params) => client.call('model_default_model_set', params),
    ...
    getUsageSessions: (params) => client.call('model_usage_sessions', params),
    getUsageEvents: (params) => client.call('model_usage_events', params),
    getUsagePricing: () => client.call('model_usage_pricing'),
    getUsageSources: () => client.call('model_usage_sources'),
    getUsageBudgets: () => client.call('model_usage_budgets'),
    upsertUsageBudget: (params) => client.call('model_usage_budget_upsert', params),
    getUsageInsights: () => client.call('model_usage_insights'),
    dismissUsageInsight: (params) => client.call('model_usage_insight_dismiss', params),
    getUsageAttention: (params) => client.call('model_usage_attention', params),
    ackUsageAttention: (params) => client.call('model_usage_attention_ack', params),
    getUsageBilling: (params) => client.call('model_usage_billing', params),
    getUsageSubjects: (params) => client.call('model_usage_subjects', params),
    upsertUsageBillingEntry: (params) => client.call('model_usage_billing_entry_upsert', params),
    collectUsage: (params) => client.call('model_usage_collect', params),
