...
- 结束 Commit：待本轮本地提交（当前基线 `c6495f061854981141d439173460a10fd1c10929`）
...
- HTTP/SSE MCP 的响应仍通过 curl 完整帧返回，取消可杀掉 curl，但尚未把 SSE 中间 progress 转成 ToolOutputDelta；stdio MCP 已支持 notifications/progress。
