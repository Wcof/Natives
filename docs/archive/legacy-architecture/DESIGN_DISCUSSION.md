...
> **文档角色**: **历史 Q&A 溯源**，不是现行约束。  
>
> ### ⚠ 已被后续 ADR 修订（阅读时请覆盖下列结论）
>
> | 主题 | 历史结论（本文） | 现行权威 |
> |------|------------------|----------|
> | 产品身份 / Steam 商店驱动 | Q1 融合商店+工坊+OS | **[ADR-0012](../adr/0012-product-identity-workshop-scope.md)**：本机 AI 工作台；商店 **P2** |
> | 薄客户端 / 前后端独立 | 部分表述偏容器商店 | ADR-0012 第 7 节：宿主内核权威 / 壳投影 / 沙箱租户 |
> | 创意双来源 | 未覆盖 | **[ADR-0013](../adr/0013-creative-app-dual-source.md)** |
> | 约束红线 | 散落在对话 | **[`docs/standards/`](../standards/README.md)** |
>
> 安全类决策（Token、origin、IPC 中转、崩溃检测等）多数已沉淀为 ADR-0001–0006，仍有效。
